 ...
 */
OpenLayers.Format.KMZ = OpenLayers.Class(OpenLayers.Format.XML, {
    ...
    /**
     * {String} specify the base path of images, etc for KML resources
     */
    kmzBase: '',
                ...
                case "iconstyle":
                    ...
                    if (iconNode) {
                        ...
                        if (href) {                                                   
                            ...
                            style["externalGraphic"] = this.kmzBase + href;
                        }
    ...
    CLASS_NAME: "OpenLayers.Format.KMZ" 
});
